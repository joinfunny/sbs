...
var pageView = require('../../react_pages/course_search.jsx');
...
var Controller = app.BaseView.extend({
    wxShareInfo: function() {
        ...
        return {
            title: '课栈网'+this.fetchData.cateName+'课程列表',
            link: location.href,
            desc: '我在课栈网发现了好多有趣课程，一起看看吧',
...
kz_m.Controllers['course_search'] = module.exports = Controller;