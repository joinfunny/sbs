require([
	...
	function initUser() {
		...
		var apiUrl = localStorage.getItem('bas_apiPath');
		var sessionId = localStorage.getItem('bas-sessionId');
		if (userId && userName) {
			if (apiUrl && sessionId) {
				...
				$.ajax({
					method: 'post',
					url: apiUrl + '/bas/services/usm/getLoginUser?sessionId=' + sessionId + '&terminalType=PC',
					data: "",
