"object" != typeof JSON && (JSON = {}),
  ...
  function(e) {
    ...
    /sa\.gif/.test(e.para.server_url) || (e.para.server_url = e.para.server_url.replace(/\/(sa)\\?/, "/$1.gif")), e.para.debug_mode_url = e.para.debug_mode_url || e.para.server_url.replace("sa.gif", "debug"), e.para.noCache === !0 ? e.para.noCache = "?" + (new Date).getTime() : e.para.noCache = "";
    var n = {};
    ! function() {
      function e(e) {
      ...
      function s(e) {
        if (p) try {
          var t = p.twGetRunPath.toLowerCase(),
            r = p.twGetSecurityID(f),
            n = p.twGetVersion(r);
      ...
      var c = "-1",
        f = window,
        p = f.external,
        l = f.navigator.userAgent || "",
        d = f.navigator.appVersion || "",
        b = f.navigator.vendor || "",
        g = /\b(?:msie |ie |trident\/[0-9].*rv[ :])([0-9.]+)/,
        h = /\bbb10\b.+?\bversion\/([\d.]+)/,
        m = /\bblackberry\b.+\bversion\/([\d.]+)/,
        v = /\bblackberry\d+\/([\d.]+)/,
        _ = [
          ["nokia", function(e) {
        ...
        y = [
          ...
          ["blackberry", function(e) {
            var t = e.match(h) || e.match(m) || e.match(v);
            return t ? {
              version: t[1]
            } : "blackberry"
          }]
        ...
        S = [
          ...
          ["maxthon", function() {
            try {
              if (p && (p.mxVersion || p.max_version)) return {
                version: p.mxVersion || p.max_version
              }
            } catch (e) {}
          ...
          ["liebao", function(e) {
            ...
            var t;
            try {
              p && p.LiebaoGetVersion && (t = p.LiebaoGetVersion())
            } catch (r) {}
            return {
              version: t || c
            }
    ...
    d.info = function() {
      ...
      function() {
        var e = (o.bind, i.forEach),
          ...
          n = Array.isArray,
          s = {},
          f = t.each = function(t, r, n) {
            if (null == t) return !1;
            if (e && t.forEach === e) t.forEach(r, n);
            else if (t.length === +t.length) {
              for (var i = 0, o = t.length; o > i; i++)
                if (i in t && r.call(n, t[i], i, t) === s) return !1
            } else
              for (var a in t)
                if (c.call(t, a) && r.call(n, t[a], a, t) === s) return !1
          };
        t.extend = function(e) {
        ...
        return t.isObject(e) ? (t.each(e, function(r, n) {
          if (t.isArray(r)) {
            var i = [];
            t.each(r, function(e) {
              t.isString(e) ? i.push(e) : d.info("您的数据-", r, "的数组里的值必须是字符串,已经将其删除")
            }), 0 !== i.length ? e[n] = i : (delete e[n], d.info("已经删除空的数组"))
          }
          t.isString(r) || t.isNumber(r) || t.isDate(r) || t.isBoolean(r) || t.isArray(r) || (d.info("您的数据-", r, "-格式不满足要求，我们已经将其删除"), delete e[n])
        }), e) : e
        ...
        var r, n, i, o, s, a, u, c, f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
          p = 0,
          l = 0,
          d = "",
          b = [];
        if (!e) return e;
        e = t.utf8Encode(e);
        do r = e.charCodeAt(p++), n = e.charCodeAt(p++), i = e.charCodeAt(p++), c = r << 16 | n << 8 | i, o = c >> 18 & 63, s = c >> 12 & 63, a = c >> 6 & 63, u = 63 & c, b[l++] = f.charAt(o) + f.charAt(s) + f.charAt(a) + f.charAt(u); while (p < e.length);
        switch (d = b.join(""), e.length % 3) {
          case 1:
            d = d.slice(0, -2) + "==";
            break;
          case 2:
        ...
        set: function(t, r, n, i, o) {
          ...
          o && (u = "; secure"), document.cookie = t + "=" + encodeURIComponent(r) + a + "; path=/" + s + u
        },
        remove: function(r, n) {
        ...
        isSupport: function() {
          ...
          try {
            ...
            t.localStorage.set(r, n), t.localStorage.get(r) !== n && (e = !1), t.localStorage.remove(r)
          } catch (i) {
            e = !1
          }
          return e
        ...
        var n = t.xhr(e.cors);
        e.type || (e.type = e.data ? "POST" : "GET"), e = t.extend({
          success: function() {},
          error: function() {}
        }, e), n.onreadystatechange = function() {
          4 == n.readyState && (n.status >= 200 && n.status < 300 || 304 == n.status ? e.success(r(n.responseText)) : e.error(r(n.responseText), n.status), n.onreadystatechange = null, n.onload = null)
        }, n.open(e.type, e.url, !0);
        try {
          if (n.withCredentials = !0, t.isObject(e.header))
        ...
        properties: function() {
          return {
            ...
            $os_version: String(n.os.version),
            $screen_height: screen.height,
            $screen_width: screen.width,
            $lib: "js",
            $lib_version: String(f),
            $browser: n.browser.name,
            $browser_version: String(n.browser.version)
          }
        },
        currentProps: {},
        register: function(e) {
    ...
    var b = {
        checkIsAddSign: function(e) {
          "track" === e.type && null !== t.cookie.get("sensorsdata_is_new_user") && (e.properties.$is_first_day = !0)
        },
        storeInitCheck: function() {
          if (l) {
            ...
            t.cookie.set("sensorsdata_is_new_user", "true", 3600 * r.h + 60 * r.m + r.s + "s")
          } else null === t.cookie.get("sensorsdata_is_new_user") && (this.checkIsAddSign = function() {})
        }
      },
      g = {};
    g.checkOption = {
      ...
      str: function(e) {
        return t.isString(e) ? !0 : (d.info("请检查参数格式,必须是字符串"), !0)
      },
      properties: function(e) {
        return t.strip_sa_properties(e), e ? t.isObject(e) ? this.checkPropertiesKey(e) ? !0 : (d.info("properties里的key必须是由字符串数字_组成，且不能是系统保留字"), !0) : (d.info("properties可以没有，但有的话必须是对象"), !0) : !0
      },
      propertiesMust: function(e) {
        return t.strip_sa_properties(e), void 0 === e || !t.isObject(e) || t.isEmptyObject(e) ? (d.info("properties必须是对象且有值"), !0) : this.checkPropertiesKey(e) ? !0 : (d.info("properties里的key必须是由字符串数字_组成，且不能是系统保留字"), !0)
      },
      event: function(e) {
        return t.isString(e) && this.regChecks.regName.test(e) ? !0 : (d.info("请检查参数格式,必须是字符串,且eventName必须是字符串_开头,且不能是系统保留字"), !0)
      },
      test_id: "str",
      group_id: "str",
      distinct_id: function(e) {
        return t.isString(e) && /^.{1,255}$/.test(e) ? !0 : (d.info("distinct_id必须是不能为空，且小于255位的字符串"), !1)
      }
    }, g.check = function(e) {
      var t = !0;
      for (var r in e)
      ...
      p.length > 0 && (n.jssdk_error = p.join("--")), t.extend(n, r), t.isObject(r.properties) && !t.isEmptyObject(r.properties) && t.extend(n.properties, r.properties), r.type && "profile" === r.type.slice(0, 7) || (n.properties = t.extend({}, t.info.properties(), h.getProps(), h.getSessionProps(), t.info.currentProps, n.properties)), n.properties.$time && t.isDate(n.properties.$time) ? (n.time = 1 * n.properties.$time, delete n.properties.$time) : e.para.use_client_time && (n.time = 1 * new Date), t.searchObjDate(n), b.checkIsAddSign(n), e.para.debug_mode === !0 ? (d.info(n), this.debugPath(JSON.stringify(n))) : (d.info(n), this.serverPath(JSON.stringify(n)))
    ...
    var h = e.store = {
        ...
        toState: function(e) {
          var r = null;
          null !== e && "object" == typeof(r = JSON.parse(e)) ? r.distinct_id ? this._state = r : (this.set("distinct_id", t.UUID()), p.push("parseCookieDistinctJSSDKError")) : (this.set("distinct_id", t.UUID()), p.push("parseCookieJSSDKError"))
        },
        ...
        save: function() {
          t.cookie.set("sensorsdata2015jssdkcross", JSON.stringify(this._state), 730, e.para.cross_subdomain)
        },
        _sessionState: {},
        _state: {},
        init: function() {
          navigator.cookieEnabled || (p.push("cookieNotEnable"), t.localStorage.isSupport || p.push("localStorageNotEnable")), this.initSessionState();
          var r = t.cookie.get(e.para.cross_subdomain ? "sensorsdata2015jssdkcross" : "sensorsdata2015jssdk");
          null === r ? (l = !0, this.set("distinct_id", t.UUID())) : this.toState(r), b.storeInitCheck()
        }
      },
      m = {
        getUtm: function() {
        ...
        setInitReferrer: function() {
          ...
          e.setOnceProfile({
            _init_referrer: r,
            _init_referrer_domain: t.info.referringDomain(r)
          })
        },
        ...
        setDefaultAttr: function() {
          t.info.register({
            ...
            _referring_domain: t.info.referringDomain(document.referrer)
          })
        },
        autoTrack: function() {
          var r = t.info.campaignParams();
          l && e.setOnceProfile(t.extend({
            $first_visit_time: new Date,
            $first_referrer: document.referrer,
            $first_referrer_host: t.info.referringDomain(document.referrer)
          }, r)), e.track("$pageview", t.extend({
            $referrer: document.referrer,
            $referrer_host: t.info.referringDomain(document.referrer),
            $url: location.href,
    ...
    e.quick = function() {
      var t = a.call(arguments),
        r = t[0],
        n = t.slice(1);
      return "string" == typeof r && m[r] ? m[r].apply(e, n) : void("function" == typeof r ? r.apply(e, n) : d.info("quick方法中没有这个功能" + t[0]))
      ...
      g.check({
        ...
        t.isString(r) ? e[n] = [r] : t.isArray(r) || (delete e[n], d.info("appendProfile属性的值必须是字符串或者数组"))
      ...
      var n = e;
      t.isString(e) && (e = {}, e[n] = 1), g.check({
        propertiesMust: e
      }) && (r(e) ? g.send({
        type: "profile_increment",
        properties: e
      }) : d.info("profile_increment的值只能是数字"))
      ...
      t.isString(e) && (e = [], e.push(r)), t.isArray(e) ? (t.each(e, function(e) {
        t.isString(e) ? n[e] = !0 : d.info("profile_unset给的数组里面的值必须时string,已经过滤掉", e)
      }), g.send({
        type: "profile_unset",
        properties: n
      })) : d.info("profile_unset的参数是数组")
    }, e.identify = function(e, r) {
      "undefined" == typeof e ? h.set("distinct_id", t.UUID()) : g.check({
        distinct_id: e
      }) ? r === !0 ? h.set("distinct_id", e) : h.change("distinct_id", e) : d.info("identify的参数必须是字符串")
      ...
      g.check({
        properties: e
      }) ? t.extend(t.info.currentProps, e) : d.info("register输入的参数有误")
    }, e.register = function(e) {
      g.check({
        properties: e
      }) ? h.setProps(e) : d.info("register输入的参数有误")
    }, e.registerOnce = function(e) {
      g.check({
        properties: e
      }) ? h.setPropsOnce("props", e) : d.info("registerOnce输入的参数有误")
    }, e.registerSession = function(e) {
      g.check({
        properties: e
      }) ? h.setSessionProps(e) : d.info("registerSession输入的参数有误")
    }, e.registerSessionOnce = function(e) {
      g.check({
        properties: e
      }) ? h.setSessionPropsOnce(e) : d.info("registerSessionOnce输入的参数有误")
    }, e.init = function() {
