"object" != typeof JSON && (JSON = {}),
	...
	function(e) {
		...
		/sa\.gif/.test(e.para.server_url) || (e.para.server_url = e.para.server_url.replace(/\/(sa)\\?/, "$1.gif")), e.para.debug_mode_url = e.para.debug_mode_url || e.para.server_url.replace("sa.gif", "debug");
		var n = {};
		! function() {
			function e(e) {
			...
			function() {
				...
				set: function(t, r, n, i, o) {
					...
					if (n = "undefined" == typeof n ? 730 : n, i) {
						var c = d.location.hostname.match(/[a-z0-9][a-z0-9\-]+\.[a-z\.]{2,6}$/i),
							f = c ? c[0] : "";
						s = f ? "; domain=." + f : ""
					}
					if (0 !== n) {
				...
				if (e.type || (e.type = e.data ? "POST" : "GET"), e = t.extend({
					...
					}, n.open(e.type, e.url, !0), n.withCredentials = !0, t.isObject(e.header))
				...
				getBrowser: function() {
					return {
						_browser: n.browser.name,
						_browser_version: String(n.browser.version)
					}
				},
				properties: function() {
		...
		var h = e.store = {
				...
				_state: {},
				init: function() {
					var r = t.cookie.get("sensorsdata2015jssdk"),
						n = t.cookie.get("sensorsdata2015jssdkcross"),
						i = null;
		...
		e.quick = function() {
			...
			"undefined" == typeof e ? h.set("distinct_id", t.UUID()) : g.check({
				distinct_id: e
			}) ? r === !0 ? h.set("distinct_id", e) : h.change("distinct_id", e) : b.info("identify的参数必须是字符串")
			...
			g.check({
				properties: e
			}) ? t.extend(t.info.currentProps, e) : b.info("register输入的参数有误")
