...
module.exports = {
    ...
    path: function (sendImmediately) {
        ...
        var randomId = sessionId;
        var sign = md5.hex_md5(dataStr + token);
        _.ajax({
            url: url,
            type: "POST",
            cors: true,
...
},{"./config":1,"./md5":5,"./store":7,"./utils":9}],3:[function(require,module,exports){
var _ = require('./utils');
...
},{"./rxStream":6,"./utils":9}],5:[function(require,module,exports){
/*
