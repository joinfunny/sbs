	...
	if(message.MsgType === 'event'){
		if(message.Event === 'subscribe'){
			...
			this.body = '亲爱的，欢迎关注科幻电影世界\n'+
						...
						'回复 电影名字， 查询电影信息\n'+
						'回复 语音， 查询电音信息\n'+
						'也可以点击 <a href="http://somnus.ngrok.cc/movie"> 语音查电影 </a>'
		...
		if(content.indexOf('哈哈') > -1){
			...
			var data = yield wechatApi.uploadMaterial('video',path.join(__dirname , '../1.mp4'),{'type' : 'video','description' : '{"title" :"nice","introduction": "nice too"}'})
